 ...
 * @author User
 */
public class LecturerViewPrsentationDate extends javax.swing.JFrame {

    Lecturer lc = null;

    public LecturerViewPrsentationDate(Lecturer lc) {
        initComponents();
        this.lc = lc;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerViewPrsentationDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
