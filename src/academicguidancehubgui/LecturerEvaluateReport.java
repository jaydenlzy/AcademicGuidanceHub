...
public class LecturerEvaluateReport extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LecturerEvaluateReport
     */
    public LecturerEvaluateReport() {
        initComponents();
    }
...
lecturerHomePage.setVisible(true);      }//GEN-LAST:event_HomePageMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerEvaluateReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerEvaluateReport().setVisible(true);
            }
        });
    }
