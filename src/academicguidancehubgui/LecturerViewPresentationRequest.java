 ...
 * @author User
 */
public class LecturerViewPresentationRequest extends javax.swing.JFrame {

    /**
     * Creates new form LecturerViewPresentationRequest
     */
    public LecturerViewPresentationRequest() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Presentation Request");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Name", "Topic", "Date Requested", "Additional Info", "Request"
            }
        ));
...
lecturerHomePage.setVisible(true);      }//GEN-LAST:event_HomePageMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerViewPresentationRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerViewPresentationRequest().setVisible(true);
            }
        });
    }
