 ...
 * @author New HP
 */
public class CreateNewIntake extends javax.swing.JFrame {

    /**
     * Creates new form CreateNewIntake
     */
    public CreateNewIntake() {
        initComponents();
        setSize(800,600);
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/degree_assignment/CreateNewIntake1.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/degree_assignment/CreateNewIntake2.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 0, 160, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateNewIntake.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateNewIntake().setVisible(true);
            }
        });
    }
