 ...
 * @author User
 */
public class LecturerViewSecondMarker extends javax.swing.JFrame {

    /**
     * Creates new form LecturerViewSecondMarker
     */
    public LecturerViewSecondMarker() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Second Marker Acceptance");
...
lecturerHomePage.setVisible(true);      }//GEN-LAST:event_HomePageMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerViewSecondMarker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerViewSecondMarker().setVisible(true);
            }
        });
    }
