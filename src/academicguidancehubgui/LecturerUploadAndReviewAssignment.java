 ...
 * @author User
 */
public class LecturerUploadAndReviewAssignment extends javax.swing.JFrame {

    /**
     * Creates new form LecturerUploadAndReviewAssignment
     */
    public LecturerUploadAndReviewAssignment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ViewSuperPage1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ViewSuperPage1MouseClicked(evt);
            }
        });
        ...
        jLabel1.setText("Upload And Review Student Assignment");
    ...
    private void ViewSuperPage1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ViewSuperPage1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_ViewSuperPage1MouseClicked
...
lecturerHomePage.setVisible(true);      }//GEN-LAST:event_HomePageMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerUploadAndReviewAssignment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerUploadAndReviewAssignment().setVisible(true);
            }
        });
    }
